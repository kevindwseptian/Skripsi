...
<head>
    ...
    <title>PT DWI OLA | Edit Data</title>
                ...
                <div class="col-md-12" >
                    <form action="{{ route('customers.update') }}" method="post">
                        ...
                        <div class="form-group has-feedback">
                            <input placeholder="Nama" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $customer->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group has-feedback">
                            <input placeholder="NIK" id="nik" type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" value="{{ $customer->nik }}" required autocomplete="nik" autofocus>
                        ...
                        <div class="form-group has-feedback">
                             <input placeholder="No Telepon" id="nohp" type="text" class="form-control @error('nohp') is-invalid @enderror" name="nohp" value="{{ $customer->notelp }}" required autocomplete="nohp" autofocus>
                        ...
                        <div class="form-group has-feedback">
                             <input placeholder="Email" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $customer->email }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group has-feedback">
                            <input placeholder="Alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ $customer->alamat }}" required autocomplete="alamat" autofocus>
