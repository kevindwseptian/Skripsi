...
<div class="wrapper">
  ...
  <header class="main-header">
    <nav class="navbar navbar-static-top">
        <div class="container">
          <div class="navbar-header">
            <a href="#" class="navbar-brand"><b>PTDwi</b>OLA</a>
          ...
          <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="#">Pangkalan</a></li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pemesanan <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="#">Order</a></li>
                  <li><a href="#">Pembayaran</a></li>
                  <li><a href="#">Invoice</a></li>
                </ul>
                <li><a href="#">Tentang Kami <span class="sr-only">(current)</span></a></li>
              <li>
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>O</b>LA</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PT Dwi</b> OLA</span>
    </a>
